...
def get_sales_data():
    """
    Getsales figures input from user.
...
"""
refactored to update worksheet
...
def update_surplus_worksheet(data):
    ##
    Update Surplus worksheet, add new row with list the data provided
    ##
...
def update_worksheet(data, worksheet):
    """
    Receives a list of integers to be inseted into a worksheet
